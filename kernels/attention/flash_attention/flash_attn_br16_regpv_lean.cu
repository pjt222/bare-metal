/*
 * flash_attn_br16_regpv_lean.cu — Flash Attention Br=16 WMMA, register-PV, lean state
 *
 ...
 *
 * Build:
 *   nvcc --cubin -arch=sm_86 -O2 -o flash_br16_regpv_lean.sm_86.cubin flash_attn_br16_regpv_lean.cu
 */
...
void flash_attn_br16_regpv_lean(
