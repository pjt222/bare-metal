/*
 * igemm_online_quant_bf_128x256.cu — Bank-conflict-free FP16->INT8 quantized GEMM
 *
 ...
 *
 * Build:
 *   nvcc --cubin -arch=sm_86 -O2 -o igemm_online_quant_bf_128x256.sm_86.cubin igemm_online_quant_bf_128x256.cu
 */
...
void igemm_online_quant_bf_128x256(
