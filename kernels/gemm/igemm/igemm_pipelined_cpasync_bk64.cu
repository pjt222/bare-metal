/*
 * igemm_pipelined_cpasync_bk64.cu — BK=64 variant of pipelined INT8 GEMM with cp.async
 *
 ...
 *
 * Shared memory: 16 KB (BK=64, doubled from BK=32 version)
 *
 * Build:
...
void igemm_pipelined_cpasync_bk64(
