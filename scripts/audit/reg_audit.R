...
#
# Usage:
#   Rscript scripts/audit/reg_audit.R                    # default outputs
#   Rscript scripts/audit/reg_audit.R --root phase3
#   Rscript scripts/audit/reg_audit.R --csv-out PATH --md-out PATH
#
...
main <- function() {
  ...
  writeLines(c(
    ...
    "",
    sprintf("Re-run: `Rscript scripts/audit/reg_audit.R`")
  ), con)
